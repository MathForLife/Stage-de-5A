function [phib, J, err_u,err_J, niter]=ChanVese(Image, mask, lambda, epsilon, Parameters, Colors, StopConditions)
...
n=Parameters(1); order=Parameters(2); eta=Parameters(3); 
